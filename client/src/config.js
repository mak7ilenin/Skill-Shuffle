...
export const API_SERVER = 'http://skillshuffle.ddns.net/api/api';
export const SERVER_URL = 'http://skillshuffle.ddns.net/api';
export const WEBSOCKET_URL = 'ws://skillshuffle.ddns.net/api/ws';
