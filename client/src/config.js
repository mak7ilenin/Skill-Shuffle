...
export const API_SERVER = 'http://skillshuffle.ddns.net/api/v1';
export const SERVER_URL = 'http://skillshuffle.ddns.net/api/v1';
export const WEBSOCKET_URL = 'ws://skillshuffle.ddns.net/api/v1/ws';
